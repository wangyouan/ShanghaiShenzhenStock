...
# @Filename: step2_find_best_strategies_of_forecast
# @Date: 2017-04-07
# @Author: Mark Wang
...
learning_path = os.path.join(const.RESULT_PATH, 'forecast_learning_result')
ori_alpha_df = pd.read_pickle(os.path.join(learning_path, 'merged_forecast_alpha_drop_unuseful.p'))
l_alpha_df = pd.read_pickle(os.path.join(learning_path, '20170407_alpha_learning.p'))

ori_raw_df = pd.read_pickle(os.path.join(learning_path, 'merged_forecast_raw_drop_unuseful.p'))
