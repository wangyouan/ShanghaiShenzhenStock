...
from ChineseStock.return_calculator.generate_holding_return_limit_up_down import calculate_return_data
...
if __name__ == '__main__':
    ...
    result_df.to_excel(os.path.join(const.TEMP_PATH, file_path, '20170412_insider_test_result.xlsx'))
    ...
    sta_df.to_excel(os.path.join(const.TEMP_PATH, file_path, '20170412_insider_test_statistics.xlsx'))
